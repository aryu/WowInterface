function Localize()
	...
	DRIVER_BLACKLISTED = "<html><body><p align=""CENTER"">Your device driver is not compatiple. Plese see <a href="": http://nydus.battle.net/WoW/enGB/launcher/driver-unsupported"">http://nydus.battle.net/WoW/enGB/launcher/driver-unsupported</a> for more information.</p></body></html>";
	DRIVER_OUTOFDATE = "<html><body><p align=""CENTER"">Your device driver is out of date. Plese see <a href=""http://nydus.battle.net/WoW/enGB/launcher/driverupdates"">http://nydus.battle.net/WoW/enGB/launcher/driverupdates</a> for more information.</p></body></html>";
	DEVICE_BLACKLISTED = "<html><body><p align=""CENTER"">Your video device is not compatiple. Plese see <a href=""http://nydus.battle.net/WoW/enGB/launcher/video-unsupported"">http://nydus.battle.net/WoW/enGB/launcher/video-unsupported</a> for more information.</p></body></html>";
